...
class Drone2D(gym.Env):
    ...
    def __init__(self, battery_capacity=40, map_path=os.path.dirname(__file__) + "/resources/map.txt"):
        # load map
        try:
            f = open(map_path)
        except IOError:
    ...
    class Viewer(pyglet.window.Window):
        def __init__(self, env):
            ...
            self.set_size(int(screen_width ), screen_height)
            ...
            house_image1 = pyglet.image.load(icon_path + "/resources/house_1.png")
            ...
            house_image2 = pyglet.image.load(icon_path + "/resources/house_2.png")
            ...
            tree_image = pyglet.image.load(icon_path + "/resources/tree.png")
            self.trees = []
            ...
            package_image = pyglet.image.load(icon_path + "/resources/package.png")
            ...
            drone_image = pyglet.image.load(icon_path + "/resources/drone.png")
            ...
            drone_image2 = pyglet.image.load(icon_path + "/resources/drone_2.png")
